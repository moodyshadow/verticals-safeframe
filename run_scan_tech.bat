...
"C:\Users\szabo\youtube-shorts-pipeline\venv\Scripts\python.exe" run_two_niches.py --niche tech >> "C:\Users\szabo\youtube-shorts-pipeline\reports\scan_log.txt" 2>&1
